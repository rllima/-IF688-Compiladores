...
public class BuildSymbolTableVisitor implements IVisitor<Void> {
		...
		if(currClass != null){
			if(currMethod != null){
				if(currMethod.containsVar(n.i.s)){
					System.out.println("A variável: " + n.i.s + " já está declarada no método!");	
				}else currMethod.addVar(n.i.s, n.t);
			}else{
				if(currClass.containsVar(n.i.s)){
					System.out.println("A variável: " + n.i.s + " já está declarada na classe!");			
				}else currClass.addVar(n.i.s, n.t);
	...
	public Void visit(Formal n) {
		...
		if(currMethod.containsParam(n.i.s)){
			System.out.println("A variável: " + n.i.s + " já foi passada como parametro do método!");		
		}else currMethod.addParam(n.i.s, n.t);
